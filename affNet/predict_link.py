...
result_cols = ['dataset', 'nodes', 'features', 'classes', 'directed', 
               ...
               'metric_value', 'metric_std', 'auc_value', 'auc_std', 
               'elapsed', 'seed']
...
for dataset_name in datasets:
    ...
    print(f"edge-homophily: {edge_h:.4f}, aff-h: {aff_h:.4f}, min_beta={min_beta:.2f}, max_beta={max_beta:.2f}, {metric_name}: {metric_value:.4f}, auc: {auc:.2f}")
    results_df.loc[len(results_df)] = [dataset_name, n_orig_nodes, n_features, n_classes, 
            ...
            metric_value, metric_std, auc_value, auc_std, elapsed, seed]
